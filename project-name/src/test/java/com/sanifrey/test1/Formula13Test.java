...
public class Formula13Test {
	...
	@Test
		 /** 
 * Тестируем метод с входными параметрами 5.5, 2, 2.5 и с предполагаемым результатом 0.5 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 5.5-2*2.5 и
 * вернёт значение: 0.5.
 */
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "2" и значением длины "2.5".
		 */
		formula.PublicAddObject( "2", "2.5");
		/**
		 ...
		 * вернёт значение: 2.0
		 */
		assertEquals("0.5",formula.PFormula("5.5"));
		/**
